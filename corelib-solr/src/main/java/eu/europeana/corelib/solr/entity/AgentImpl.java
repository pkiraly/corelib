...
public class AgentImpl extends ContextualClassImpl implements Agent {
	...
	public int hashCode() {
		...
		hash = 31 * hash
				+ (null == this.getAbout() ? 0 : this.getAbout().hashCode());
		return hash;
	}

	@Override
	public void setEdmWasPresentAt(String[] edmWasPresentAt) {
		this.edmWasPresentAt = edmWasPresentAt != null ? edmWasPresentAt
				.clone() : null;
	}

	@Override
	public String[] getEdmWasPresentAt() {
		return (StringArrayUtils.isNotBlank(this.edmWasPresentAt) ? this.edmWasPresentAt
				.clone() : null);
	}
	...
	public String[] getOwlSameAs() {
		return (StringArrayUtils.isNotBlank(this.owlSameAs) ? this.owlSameAs
				.clone() : null);
	}
	...
	@Override
	public void setRdaGr2DateOfEstablishment(
			Map<String, List<String>> rdaGr2DateOfEstablishment) {
	...
	@Override
	public void setRdaGr2DateOfTermination(
			Map<String, List<String>> rdaGr2DateOfTermination) {
	...
	public void setRdaGr2ProfessionOrOccupation(
			Map<String, List<String>> rdaGr2ProfessionOrOccupation) {
	...
	public void setRdaGr2BiographicalInformation(
			Map<String, List<String>> rdaGr2BiographicalInformation) {
